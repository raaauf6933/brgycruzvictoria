...
@section('title', 'Barangay Cruz, Victoria | Announcements')
                            ...
                            <div class="col-md-10">
                                <div class="card-body">
                                    <div class='dropdown float-end'>
                                        <a class='btn btn-sm btn-icon-only text-muted' href='#' role='button'
                                            data-bs-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                                            <i class='fas fa-ellipsis-v'></i>
                                        </a>
                                        <div class='dropdown-menu dropdown-menu-right dropdown-menu-arrow'>
                                            <a class='dropdown-item'
                                                href="{{ route('guest.announcements.show', $announcement) }}">View</a>
                                        </div>
                                    </div>
