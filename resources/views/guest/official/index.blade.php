...
@section('title', 'Barangay Cruz, Victoria | Officials')

@section('content')
    <!-- Page content -->
    <div class="container-fluid mt-3"><br>
        <h1 class="text-success text-center">List of Officials</h1><br><br>
        <div class="row g-0 team-items">
            @foreach ($officials as $official)
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid d-block mx-auto" src="{{ asset('img/noimg.svg') }}" width="150"
                                alt="">
        ...
        <h1 class="text-success text-center">Barangay Officials Chart</h1>
