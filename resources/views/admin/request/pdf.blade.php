                        ...
                        @if ($request->service->name == 'Barangay Business Clearance')
                            <div id="container-wrapper">
                                ...
                                <h3 class="font-weight-normal pl-5">This is to certify that
                                    <strong>{{ $request->user->resident->full_name }}</strong> is bonified at Cruz,
                                    Victoria,
                                    Tarlac is hereby allowed to engage a <strong>{{ $request->business_name }}</strong> in
                                    this Barangay.
                                </h3>
                                <br>
                        ...
                        @elseif ($request->service->name == 'Barangay Clearance')
                            <div id="container-wrapper">
                                ...
                                <h3 class="font-weight-normal pl-5">This is to certify that
                                    ...
                                    single/married with residence and postal address at Barangay Cruz, Victoria, Tarlac has
                            ...
                            <div class="row mt-5">
                                <div class="col-6">
                                    ...
                                    <h3 class="font-weight-normal mb-0">Issue at: Victoria, Tarlac</h3>
                                </div>
                                <div class="col-6 pr-5">
                        ...
                        @elseif ($request->service->name == 'Certificate of Residency')
                            <div id="container-wrapper">
                                ...
                                <h3 class="font-weight-normal pl-5">Based on the records of this Office she/he has been
                                    residing
                                    at Barangay Cruz, Victoria, Tarlac for
