...
<title>@yield('title', 'Barangay Cruz, Victoria')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-success navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn"
        ...
        <a href="/" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="text-white m-0"><img class="img-fluid me-3" src="{{ asset('img/logo/logo.png') }}" alt="Icon"
                    width="100">Barangay Cruz
            </h1>
        </a>
