...
(OrgChart._defaultConfig = function (t) {
    ...
    (OrgChart.prototype.load = function (t) {
        return (
            (this.config.nodes = t), this._draw(!1, OrgChart.action.init), this
        );
    }),
                            ...
                            if (
                                ...
                                e === OrgChart.action.centerNode
                                    ...
                                    ? 0 == m[0].length &&
                                      (f ||
                                          (i && i(),
                                          OrgChart.events.publish("redraw", [
                                              a,
                                          ]),
                                          (f = !0)))
                                    : OrgChart.animate(
    ...
    (OrgChart.prototype.ripple = function (t, e, r) {
        ...
        if (null != i) {
            ...
            if (null != a) {
                ...
                f.setAttribute("id", b);
                var O = {
                    ripple: OrgChart.t(i.templateName, i.min, this.getScale())
                        .ripple,
                    node: i,
                };
                OrgChart.events.publish("ripple", [this, O]),
                    ...
                    m.setAttribute(
                        "width",
                        O.ripple.rect ? O.ripple.rect.width : i.w
                    ),
                    m.setAttribute(
                        "height",
                        O.ripple.rect ? O.ripple.rect.height : i.h
                    ),
    ...
    (OrgChart.prototype.search = function (t, e, r) {
        return (
            OrgChart.isNEU(e) && (e = this.config.searchFields),
        ...
        if (e)
            for (var r = this.config.nodes.length - 1; r >= 0; r--)
                (this.config.nodes[r].pid != t &&
                    this.config.nodes[r].stpid != t) ||
                    ((this.config.nodes[r].pid = e.pid),
                    (this.config.nodes[r].stpid = e.stpid)),
                    this.config.nodes[r].id == t &&
                        this.config.nodes.splice(r, 1);
        return this;
    }),
                    ...
                    for (var g in r[d]) {
                        ...
                        switch (g.toLowerCase()) {
                            case "d":
                                ...
                                t[d].setAttribute(
                                    "d",
                                    t[d].getAttribute("d") + " L" + u + " " + f
                                );
                                break;
                            case "r":
                                var m =
                                    a((h * s - s) / i) * (r[d][g] - e[d][g]) +
                                    e[d][g];
    ...
    (OrgChart.editUI.prototype.show = function (t, e, r) {
        ...
        this.obj.element.appendChild(a.element),
            ...
            this.obj.element
                ...
                .addEventListener("click", function (e) {
                    e.preventDefault(),
                        !1 !==
                            OrgChart.events.publish("cancel", [i, { id: t }]) &&
                            i.hide();
                }),
            this.obj.element
        ...
        for (
            var n = this.obj.element.querySelectorAll("[boc-input-btn]"), o = 0;
            o < n.length;
            o++
        ) {
            ...
            .addEventListener("click", function (t) {
                ...
                a.focus(),
                    a.nextElementSibling.addEventListener(
                        ...
                        function (t) {
                            t.stopPropagation(), t.preventDefault();
                            var r = i.obj.element.querySelector(
            ...
            this.obj.element
                ...
                .addEventListener("click", function (e) {
                    for (
                        ...
                        r &&
                        r.hasAttribute &&
                        !r.hasAttribute("data-edit-from-btn");
                    ...
                    if (r && r.hasAttribute) {
                        ...
                        if (
                            !1 ===
                            OrgChart.events.publish("button-click", [i, o])
                        )
                            return !1;
                        switch (n) {
                            case "edit":
        ...
        return (
            (A.innerHTML = `<div>\n                        <div class="boc-edit-form-header" ${I}>\n                            ${L}\n                            <h1 class="boc-edit-form-title">${C}</h1>\n                            <div id="boc-avatar" class="boc-edit-form-avatar">${b}</div>                        \n                        </div>\n                        <div data-boc-edit-from-btns class="boc-edit-form-instruments">\n                        ${(function () {
                ...
                for (var t = "", r = 0; r < l.length; r++) {
                    ...
                    if (Array.isArray(i)) {
                        t +=
                            '<div class="boc-form-field-100 boc-form-fieldset">';
            ...
            { element: A, focusId: n, title: C, shareText: N.join("\n") }
        );
    }),
    ...
    (OrgChart.idb._open = function (t) {
        if (OrgChart._browser().msie) t && t(!1);
            ...
            if (null == OrgChart.idb.db) {
                var e = indexedDB.open(
                    OrgChart.idb.dbName,
                    OrgChart.idb.version
                );
    ...
    (OrgChart.toolbarUI.prototype.init = function (t, e) {
        if (e) {
            ...
            var r = this.div.querySelector(
                    "[" + OrgChart.attr.tlbr + '="plus"]'
                ),
                i = this.div.querySelector(
                    "[" + OrgChart.attr.tlbr + '="minus"]'
                ),
                a = this.div.querySelector(
                    "[" + OrgChart.attr.tlbr + '="fit"]'
                ),
                n = this.div.querySelector(
                    "[" + OrgChart.attr.tlbr + '="fullScreen"]'
                ),
                o = this.div.querySelector(
                    "[" + OrgChart.attr.tlbr + '="expand"]'
                ),
                l = this;
            r &&
                ...
                this.layouts &&
                    this.layouts.addEventListener("click", function (t) {
                        for (var e = t.target; e; ) {
                            if (
                                e.hasAttribute &&
                                e.hasAttribute(OrgChart.attr.layout)
                            ) {
            ...
            this._draw(!1, OrgChart.action.exporting, i, function (i) {
                ...
                if ("svg" == t.ext)
                    if (e) e(t, a.innerHTML);
                        ...
                        if (
                            !1 ===
                            (s = OrgChart.events.publish("exportend", [r, l]))
                        )
                            return !1;
                            ...
                            e
                                ...
                                : ((n = JSON.stringify(n)),
                                  OrgChart._ajax(
                                      ...
                                      "arraybuffer",
                                      function (e) {
                                          var i = OrgChart.events.publish(
                                              "exportend",
                                              [r, e]
                                          );
                                          if (
                                              (OrgChart.loading.hide(r),
                                              !1 === i)
                                          )
                                              return !1;
                                          OrgChart._downloadFile(
    ...
    (OrgChart.prototype._pagesA100 = function (t, e, r) {
        ...
        for (
            var g = c.w * (100 / r), p = c.h * (100 / r), u = o, f = l, m = [];
            u < s + o;
            ...
            for (; f < h + l; ) {
                var C = [u, f, g, p];
                (C = C.join()),
                    m.push({ vb: C, innerSize: c, size: d }),
                    (f += p);
            }
            (u += g), (f = l);
        }
    ...
    (OrgChart.prototype._exportProfile = function (t, e) {
        ...
        if (c)
            for (var d = 0; d < c.children.length; d++)
                "style" == c.children[d].nodeName.toLowerCase() &&
                    (s.styles += c.children[d].outerHTML);
        (s = JSON.stringify(s)),
            OrgChart._ajax(
    ...
    (OrgChart._importSetColumnNames = function (t, e) {
        if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
            ...
            for (var u = 0; u < t.length; u++) {
                (O = document.createElement("option")).setAttribute(
                    "value",
                    t[u]
                );
    ...
    (OrgChart.prototype._expCollHandler = function (t) {
        ...
        if (r.length) {
            if (
                !1 === OrgChart.events.publish("expcollclick", [this, !1, t, r])
            )
                return !1;
            this.expand(t, r, !1);
        } else {
    ...
    (OrgChart.prototype._mouseScrollHandler = function (t, e) {
        if (this.config.mouseScrool != OrgChart.action.ctrlZoom || e.ctrlKey) {
            var r = this,
                ...
                o = 0,
                l = this.getScale(),
                s = OrgChart._centerPointInPercent(
                    r.getSvg(),
                    e.pageX,
                    e.pageY
                ),
        ...
        if (n.draggable) {
            ...
            var O = function (t, e) {
                    if (null != t) {
                        ...
                        for (
                            var r = OrgChart.getStParentNodes(o.getNode(c)),
                                i = 0;
                            i < r.length;
                            i++
                        ) {
                    ...
                    if (p) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            for (
                                ...
                                if (
                                    i.hasAttribute &&
                                    i.hasAttribute(OrgChart.attr.node_id)
                                ) {
                                    var I = i.getAttribute(
                                        OrgChart.attr.node_id
                                    );
                                    (c = I), (d = i);
                                    break;
                            ...
                            if (
                                ...
                                !t._dragEventFired &&
                                    (Math.abs(r.x - p.x) >
                                        OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                                        Math.abs(r.y - p.y) >
                                            OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                            )
                                !1 ===
    ...
    (OrgChart.prototype._nodeMouseDownHandler = function (t, e, r) {
        if (this.config.enableDragDrop) {
            ...
            var s = this,
                ...
                u = s.getScale(),
                f = t.cloneNode(!0);
            h.insertBefore(f, h.firstChild), (f.style.opacity = 0.7);
            var m = function (t, e) {
                    if (null != t) {
                        e.classList.remove("boc-drag-over");
                        for (
                            var r = s.getNode(o),
                                i = OrgChart.getStParentNodes(r),
                                a = 0;
                            a < i.length;
                            a++
                        ) {
                ...
                b = function (e) {
                    if (
                        ...
                        return (
                            ...
                            void (
                                t._dragEventFired &&
                                OrgChart.events.publish("drop", [s, n.id])
                            )
                        );
                    var i = s.getNode(o);
    ...
    (OrgChart.prototype.toggleExpandCollapse = function (t, e) {
        ...
        if (i.length) {
            if (
                !1 === OrgChart.events.publish("expcollclick", [this, !1, t, i])
            )
                return !1;
            this.expand(t, i, !1);
        } else {
    ...
    (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
        ...
        if ("pan" == s.type) {
            ...
            (h.style.display = "inherit"),
                ...
                OrgChart.animate(
                    h,
                    { transform: [0, 0, 0, 0, d, g], opacity: 0 },
                    { transform: [1 / n, 0, 0, 1 / n, d, g], opacity: 1 },
                    300,
                    OrgChart.anim.outBack
                );
        }
        var p = function (t) {
                ...
                if (s && "pan" == s.type) {
                    ...
                    s.dist = h;
                    var d = OrgChart._pinchMiddlePointInPercent(
                        i.element,
                        i.width(),
                        i.height(),
                        t
            ...
            u = function () {
                "pan" == s.type && i.config.sticky
                    ...
                    t.removeEventListener(r.up, u),
                    r.leave && t.removeEventListener(r.leave, u),
                    r.touchstart && t.removeEventListener(r.touchstart, u);
            };
        t.addEventListener(r.move, p),
            t.addEventListener(r.up, u),
            r.leave && t.addEventListener(r.leave, u),
            r.touchstart && t.addEventListener(r.touchstart, u);
    }),
        ...
        var n = function () {
            ...
            l = function () {
                ...
                if (t) {
                    ...
                    0 != OrgChart.events.publish("searchclick", [e.obj, r]) &&
                        e.obj.center(r);
                }
            };
    }),
    ...
    (OrgChart.searchUI.prototype.find = function (t) {
        this.input &&
            ((this.input.value = t), this._serverSearch(t), this.input.focus());
    }),
    (OrgChart.searchUI.prototype._serverSearch = function (t) {
        var e = this,
            r = OrgChart._search.search(
            ...
            a = `<table border="0" cellspacing="0" cellpadding="0">\n                    <tbody>\n                        ${(function () {
                for (
                    var t = "", a = 0;
                    a < r.length && !(a >= OrgChart.SEARCH_RESULT_LIMIT);
                    a++
                ) {
                    var n = r[a],
                        o = "";
                    if (i) {
                        ...
                        "function" == typeof i
                            ? (o = i(e.obj, e.obj.getNode(n.id), l))
                            : l[i] && (o = l[i]);
                    }
                    var s = "",
                        h = "";
                    e.obj.config.searchDisplayField == n.__searchField
                        ? (s = n.__searchMarks)
                        : e.obj.config.searchDisplayField
                        ? ((s = n[e.obj.config.searchDisplayField]),
                          OrgChart.isNEU(s) && (s = ""),
                          (h = n.__searchMarks))
                        : (s = n.__searchMarks),
        ...
        for (
            var n = this.obj.element.querySelectorAll("[data-search-item-id]"),
                o = 0;
            o < n.length;
            o++
        )
    ...
    (OrgChart.manager.prototype._read = function (t, e) {
        ...
        null == o && (o = OrgChart.local),
            o._setPositions(
                ...
                function (e) {
                    var o =
                        OrgChart.manager._doNotChangePositionOfClickedNodeIfAny(
                            n,
                            a,
                            r.action,
                            r.actionParams,
    ...
    (OrgChart.manager._initNode = function (t, e, r, i, a, n, o) {
        var l = o.manager.config,
            ...
            g = s[r || "base"];
        null == t.parent &&
            OrgChart.manager._setCollpasedProperty(t, g, c, a, h, i - 1, d);
        for (var p = 0; p < t.childrenIds.length; p++) {
            var u = e[t.childrenIds[p]];
            if (
                (OrgChart.manager._setCollpasedProperty(u, g, c, a, h, i, d),
                !u.collapsed)
            ) {
        ...
        if (
            (t.min ||
                h != OrgChart.action.minimize ||
                ((c.all || c.id == t.id) && (t.min = !0)),
            !0 === t.min &&
                h == OrgChart.action.maximize &&
                (c.all || c.id == t.id) &&
                (t.min = !1),
            ...
            for (p = 0; p < t.stChildrenIds.length; p++) {
                ((u = e[t.stChildrenIds[p]]).stParent = t),
                    t.stChildren.push(u);
            }
    ...
    (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
        for (var s = r.nodes, h = [], c = 0; c < s.length; c++) {
            ...
            (d = OrgChart.STRING_TAGS
                ...
                ? g.tags.slice(0)
                : []),
                l.filterUI.addFilterTag(g) && d.push("filter");
            var p = OrgChart._getTemplate(d, r.tags, r.template),
                u = new OrgChart.node(g.id, g.pid, d, p);
            OrgChart.isNEU(g.ppid) || (u.ppid = g.ppid),
                OrgChart.isNEU(g.stpid) || (u.stpid = g.stpid),
                null != r.orderBy &&
                    (u.order = OrgChart.manager._getOrderFieldValue(
                        g,
                        r.orderBy
                    )),
                (t[g.id] = u),
        ...
        for (c = 0; c < h.length; c++) {
            ...
            if ((C || (u.stpid = null), b || (u.pid = null), C)) {
                ...
                b
                    ? (m && ((u.collapsed = m.collapsed), (u.min = m.min)),
    ...
    (OrgChart.manager._createNodes = function (t) {
        var e = t.manager.config,
            ...
            h = [];
        if (
            (OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t),
            null != e.roots)
        ) {
            s = [];
                    ...
                    for (var g = d; null != g.pid || null != g.stpid; )
                        g =
                            null == g.pid && null != g.stpid
                                ? l[g.stpid]
                                : l[g.pid];
                    for (var p = l[a.id]; null != p.pid || null != p.stpid; )
                        p =
                ...
                if (d) {
                    ...
                    if (!u) {
                        if (!OrgChart.isNEU(d.pid))
                            (R = (O = l[d.pid]).childrenIds.indexOf(d.id)) >
                                -1 && O.childrenIds.splice(R, 1);
                        s.push(d);
                    }
                }
            }
            ...
            for (var v = l[a.id]; v; ) {
                if (
                    ...
                    a.options.parentState ===
                        OrgChart.COLLAPSE_PARENT_NEIGHBORS && v)
                )
        ...
        for (c = 0; c < I.length; c++) {
            ...
            for (x = 0; x < C.children.length; x++) {
                (j = C.children[x]).isAssistant
                    ? A.push(j.id)
                    : -1 != j.tags.indexOf("right-partner")
                    ? ((j.isPartner = 1), (j.children = []), N.push(j.id))
                    : -1 != j.tags.indexOf("left-partner")
                    ? ((j.isPartner = 2), (j.children = []), L.push(j.id))
                    : -1 == j.tags.indexOf("partner") || M % 2
                    ? -1 != j.tags.indexOf("partner") && M % 2
                        ? ((j.isPartner = 2),
                          (j.children = []),
                          L.push(j.id),
                          M++)
                        : j.parentPartner
                        ? (E[j.parentPartner.id] ||
                              (E[j.parentPartner.id] = []),
                          E[j.parentPartner.id].push(j.id))
                        : A.push(j.id)
                    : ((j.isPartner = 1), (j.children = []), N.push(j.id), M++);
            }
            C.children = [];
            var F = [];
            for (x = 0; x < N.length; x++) {
                E[(j = l[N[x]]).id]
                    ? C.children.push(j)
                    : C.children.splice(0, 0, j);
                for (var z = 0; z < j.childrenIds.length; z++)
                    F.push(j.childrenIds[z]);
            }
            var H = [];
            for (x = 0; x < L.length; x++) {
                E[(j = l[L[x]]).id]
                    ? C.children.push(j)
                    : C.children.splice(0, 0, j);
                for (z = 0; z < j.childrenIds.length; z++)
                    H.push(j.childrenIds[z]);
            }
            for (x = 0; x < H.length; x++) {
                (j = l[H[x]]).collapsed ||
                    ((j.parentPartner = j.parent),
                    (j.parent = C),
                    (j.isChildOfPartner = !0),
                    C.children.push(j));
            }
            for (x = L.length - 1; x >= 0; x--)
                if (E[L[x]])
                    for (f = 0; f < E[L[x]].length; f++)
                        C.children.push(l[E[L[x]][f]]),
                            T++,
                            -1 == P.indexOf(L[x]) && P.push(L[x]);
            ...
            for (x = 0; x < N.length; x++)
                if (E[N[x]])
                    for (f = 0; f < E[N[x]].length; f++)
                        C.children.push(l[E[N[x]][f]]),
                            B++,
                            -1 == U.indexOf(N[x]) && U.push(N[x]);
        ...
        for (c = 0; c < k.length; c++) {
            if (
                (it = r[(C = l[k[c]]).lcn ? C.lcn : "base"]).layout ==
                    OrgChart.normal ||
                !S[C.pid]
            )
                for (x = 0; x < C.subLevels; x++) {
                    ...
                    if (
                        (OrgChart.manager._initDinamicNode(D, C.lcn),
                        (O = C.parent))
                    )
                        (R = O.children.indexOf(C)) > -1 &&
        ...
        for (var q in w) {
                    ...
                    : j.isPartner ||
                      (j.parent &&
                          ...
                          (Object.defineProperty(
                              S,
                              D.id,
                              Object.getOwnPropertyDescriptor(S, j.parent.id)
                          ),
                          delete S[j.parent.id]),
                      (j.parent = D),
                      D.children.unshift(j),
                      O.children.splice(x, 1));
            }
            if (Y.length % 2) {
                ...
                OrgChart.manager._initDinamicNode($, X.lcn, !0),
                    (X._m = $.id),
                    ($.isAssistant = !0),
                    ($.w = X.w),
                    ($.h = X.h),
            ...
            for (x = Y.length - 1; x >= 0; x--)
                if (x % 2 && x != Y.length - 1) {
                    var W = new OrgChart.node(
                        O.id + "_split_assitant_" + V,
                        null,
                        [],
                        "split"
                    );
                    OrgChart.manager._initDinamicNode(W, O.lcn, !0),
                        (l[W.id] = W),
                        Y.splice(x, 0, W.id),
                        V++;
                } else x % 2 && Y.splice(x, 0, D.id);
        ...
        for (var tt in r) {
            if (
                (it = r[tt]).layout == OrgChart.mixed ||
                it.layout == OrgChart.tree ||
                it.layout == OrgChart.treeRightOffset ||
                it.layout == OrgChart.treeLeftOffset
            ) {
                Q = !0;
                break;
            }
        ...
        if (Q || et) {
            ...
            for (var q in S) {
                var it;
                if (
                    (it = r[(O = l[q]).lcn ? O.lcn : "base"]).layout ==
                        OrgChart.mixed ||
                    it.layout == OrgChart.tree ||
                    it.layout == OrgChart.treeRightOffset ||
                    it.layout == OrgChart.treeLeftOffset ||
                    ...
                    if (
                        ...
                        OrgChart.manager._initDinamicNode(D, O.lcn),
                            (l[D.id] = D),
                            (D.layout = OrgChart.tree);
                        var ot = [];
                        for (c = rt.childrenIds.length - 1; c >= 0; c--) {
                            for (
                                j = l[rt.childrenIds[c]], x = 0;
                                x < O.children.length;
                                x++
                            )
                                O.children[x].id == j.id &&
                                    O.children.splice(x, 1);
                            if (
                                ((j.parent = null),
                                ...
                                var lt = new OrgChart.node(
                                    j.id + "_mirror",
                                    null,
                                    [],
                                    "mirror"
                                );
                                OrgChart.manager._initDinamicNode(lt, j.lcn),
                                    (lt.layout = OrgChart.tree),
                                    (l[lt.id] = lt),
                                    ot.splice(0, 0, lt.id);
                            }
                            rt.layout != OrgChart.treeRightOffset &&
                        ...
                        for (V = 1, x = ot.length - 1; x >= 0; x--)
                            if (x % 2 && x != ot.length - 1) {
                                W = new OrgChart.node(
                                    O.id + "_split_" + V,
                                    null,
                                    [],
                                ...
                                OrgChart.manager._initDinamicNode(W, O.lcn),
    ...
    (OrgChart.manager._getResponse = function (
        ...
        if (
            ...
            if (y - 2 * i.padding >= a - o)
                ...
                switch (
                    ((w =
                        f.x - y / 2 + OrgChart.manager._getNodeWidth(f, i) / 2),
                    i.orientation)
                ) {
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        (w = -(y / 2 - (o - a) / 2)) < i.padding - y &&
                            (w = i.padding - y);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.bottom_left:
            ...
            if (_ - 2 * i.padding >= n - l)
                ...
                switch (
                    ((k = -(_ / 2 - (n - l) / 2)) > -i.padding &&
                        (k = -i.padding),
                    i.orientation)
                ) {
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        (k = -(_ / 2 - (l - n) / 2)) < i.padding - _ &&
                            (k = i.padding - _);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.right:
                        k =
                            f.y -
                            _ / 2 +
                            OrgChart.manager._getNodeWidth(f, i) / 2;
                }
            s = [w, k, y, _];
        ...
        if (
            ...
            if (
                ...
                (I = g[d.id]), (I = OrgChart.manager._getMostDeepChild(I, g));
            ...
            if (
                ...
                if (((c = { x: (u = l[t.id]).x, y: u.y }), u)) {
                    ...
                    for (var d = t, g = null; null != d; )
                        l[d.id] && l[d.id].collapsed && (g = d), (d = d.parent);
                ...
                if (
                    ((c = { x: (u = l[t.id]).x, y: u.y }), "all" == n.ids && u)
                ) {
                    c = { x: u.x, y: u.y };
                    for (d = t, g = null; null != d; )
                        l[d.id] && l[d.id].collapsed && (g = d), (d = d.parent);
                    g && g.parent && (c = { x: g.parent.x, y: g.parent.y });
                }
                if ((f = e[n.id])) {
                    for (
                        d = t.parent;
                        null != d &&
                        -1 == n.ids.indexOf(t.id) &&
                        -1 == n.ids.indexOf(d.id);
                ...
                if (
                    (!(u = l[t.id]) ||
                        (OrgChart.isNEU(u.x) && OrgChart.isNEU(u.y))) &&
                    n
                ) {
                    if ((f = e[n.id])) {
    ...
    (OrgChart.manager._addExpandedNodeIdsIterate = function (t, e, r) {
        for (var i = 0; i < t.childrenIds.length; i++)
            r.push(t.childrenIds[i]),
                OrgChart.manager._addExpandedNodeIdsIterate(
                    e[t.childrenIds[i]],
                    e,
                    r
                );
    ...
    (OrgChart.ui = {
        ...
        node: function (t, e, r, i, a, n, o, l, s, h) {
            ...
            c.defs &&
                (d = d.replaceAll(
                    "{randId}",
                    OrgChart.ui._defsIds[t.templateName]
                )),
                ...
                if (
                    ...
                    if (null != g.value && null != g.value && null != g.element)
                        OrgChart._lblIsImg(i, p) ||
                            ...
                            (g.value = OrgChart.wrapText(g.value, g.element)),
                            (d += g.element
            ...
            return (d =
                (O = O.replace("{opacity}", v)) +
                (d += OrgChart.ui.nodeBtns(i, t, l, c, h)) +
                OrgChart.grCloseTag);
        },
                ...
                if (e.childrenIds.length > 0) {
                    if (e.hasPartners) {
                        for (var c = !1, d = 0; d < e.children.length; d++)
                            e.children[d].parentPartner ||
                                e.children[d].isPartner ||
                                (c = !0);
                        if (!c) return "";
                    }
                        ...
                        ? ((u.ppnodes[m.id] = m.parentPartner),
                          ...
                          1 == m.parentPartner.isPartner
                              ? (-1 == u.rightIds.indexOf(m.parentPartner.id) &&
                                ...
                                (u.indexes[m.id] = u.rightIds.indexOf(
                                    m.parentPartner.id
                                )),
                              ...
                              : 2 == m.parentPartner.isPartner &&
                                ...
                                (u.indexes[m.id] = u.leftIds.indexOf(
                                    m.parentPartner.id
                                )),
                                (u.lastLeft = m)))
                        : m.isPartner ||
            ...
            for (f = 0; f < t.children.length; f++) {
                    ...
                    switch (l.orientation) {
                        ...
                        case OrgChart.orientation.top_left:
                            var v =
                                1 == m.layout
                                    ? void 0
                                    : C.minY - (C.minY - p.maxY) / 2;
                            b = OrgChart.ui._linkTopToBottom(
                                m.parentPartner,
                                m,
                                s,
                                c,
                        ...
                        case OrgChart.orientation.bottom_left:
                            v =
                                1 == m.layout
                                    ? void 0
                                    : C.maxY - (C.maxY - p.minY) / 2;
                            b = OrgChart.ui._linkBottomToTop(
                                m.parentPartner,
                                m,
                                s,
                                c,
                        ...
                        case OrgChart.orientation.right_top:
                            v =
                                1 == m.layout
                                    ? void 0
                                    : C.maxX - (C.maxX - p.minX) / 2;
                            b = OrgChart.ui._linkRightToLeft(
                                m.parentPartner,
                                m,
                                s,
                                c,
                        ...
                        case OrgChart.orientation.left_top:
                            v =
                                1 == m.layout
                                    ? void 0
                                    : C.minX - (C.minX - p.maxX) / 2;
                            b = OrgChart.ui._linkLeftToRight(
                                m.parentPartner,
                                m,
                                s,
                                c,
                ...
                if (-1 != O.indexOf("{rounded}"))
                    if (
                        ...
                        var x = OrgChart.ui._roundedEdge(
                                b.xa,
                                b.ya,
                                b.xb,
                                b.yb,
                ...
                for (var k in e.config.linkBinding) {
                    ...
                    if (I) {
                        ...
                        (_.value = A),
                            (_.element = s[k]),
                            (_.name = S),
                            !1 !== OrgChart.events.publish("label", [e, _]) &&
                                (OrgChart.isNEU(_.value) ||
                                    OrgChart.isNEU(_.element) ||
        ...
        menuButton: function (t) {
            return null == t.menu
                ? ""
                : OrgChart.t(t.template, !1).menuButton.replaceAll(
                      "{p}",
                      t.padding
                  );
        },
    ...
    (OrgChart.wrapText = function (t, e) {
        ...
        if (
            ...
            for (var f = p.getComputedTextLength(), m = 2; f > c; )
        ...
        if (-1 != d.indexOf("multiline")) {
            ...
            if (null != p.innerHTML) (k = p.innerHTML), (p.innerHTML = "");
                ...
                for (y = p.childNodes.length - 1; y >= 0; y--)
                    (S =
                        XMLSerializer().serializeToString(p.childNodes[y]) + S),
    ...
    (OrgChart._getPosition = function (t, e, r, i) {
        var a = { x: e.x, y: e.y };
        if (
            (null != r && (a.x = r), null != i && (a.y = r), t && 3 == t.length)
        ) {
    ...
    (OrgChart._json2csv = function (t) {
        for (
            ...
            for (var n in t[a])
                OrgChart._arrayContains(e, n) || (e.push(n), (i += n + ","));
    ...
    (OrgChart.convertCsvToNodes = function (t) {
        for (
            ...
            for (var n = {}, o = 0; o < e[a].length; o++) {
                if ("tags" == r[o] && "" != e[a][o])
                    e[a][o] = e[a][o].split(",");
                else if ("tags" == r[o] && "" == e[a][o]) continue;
                n[r[o]] = e[a][o];
            }
            "" != n.id.trim() && i.push(n);
        }
    ...
    (OrgChart.pdfPrevUI._handler = function (t, e, r) {
        ...
        for (
            ...
            g.open(),
                ...
                a[c].backgroundColor &&
                    (d.style.backgroundColor = a[c].backgroundColor);
            var p = i.header;
    ...
    (OrgChart.prototype._clink = function (t, e) {
        for (
            ...
            function A(t, e, r) {
                ...
                return (
                    (n =
                        (n / (Math.sqrt(i * i + a * a) * r)) *
                        OrgChart.CLINK_CURVE),
    ...
    (OrgChart.prototype._slinks = function (t, e) {
        ...
        function n(e, n, o) {
            ...
            var C = n.level;
            if ((n.subLevels && (C += n.subLevels), m == C))
                ...
                for (var b = e; null == h; ) {
                    ...
                    if (
                        (v.id == n.id
                            ...
                            : OrgChart._intersects(v, f, t.config) &&
                              ((f = OrgChart._addPoint(v, s, t.config, f, c)),
                              (O = !0)),
                        v.id != n.id)
                    ) {
                        for (; x; ) {
                            ...
                            OrgChart._intersects(x, f, t.config) &&
                                ((f = OrgChart._addPoint(x, s, t.config, f, c)),
                                (O = !0)),
                                (x = x.leftNeighbor);
                        }
                        for (; y; ) {
                            ...
                            OrgChart._intersects(y, f, t.config) &&
                                ((f = OrgChart._addPoint(y, s, t.config, f, c)),
                                (O = !0)),
                                (y = y.rightNeighbor);
                        }
                    }
                    if (!O) {
                        ...
                        if (v.parent)
                            switch (
                                ((u = g.levelSeparation),
                                (v.parent.layout != OrgChart.mixed &&
                                    v.parent.layout != OrgChart.tree) ||
                                    (u = g.mixedHierarchyNodesSeparation),
                                g.orientation)
                            ) {
                                case OrgChart.orientation.top:
        ...
        for (var o = 0; o < this.config.slinks.length; o++) {
            ...
            s &&
                ...
                (s.level >= h.level ? n(s, h, !1) : n(h, s, !0));
        }
        e.content += r;
    }),
                ...
                if (Array.isArray(r))
                    ...
                    for (a = 0; a < r.stChildrenIds.length; a++)
                        h++,
                            c.includes(r.id) ||
                                (1 == h
                                    ? (i.fillStyle = OrgChart.miniMap.colors[0])
                                    : 2 == h
                                    ? (i.fillStyle = OrgChart.miniMap.colors[1])
                                    : 3 == h &&
                                      (i.fillStyle =
                                          OrgChart.miniMap.colors[2]),
                                i.beginPath(),
                                i.fillRect(r.x, r.y, r.w, r.h),
                                i.strokeRect(r.x, r.y, r.w, r.h),
                                c.push(r.id)),
    ...
    (OrgChart.miniMap._getCanvas = function (t) {
        if (
            !(e = t.element.querySelector(
                "[" + OrgChart.attr.id + '="mini-map"]'
            ))
        ) {
            var e;
        ...
        for (var s = {}, h = 0; h < t.length; h++)
            for (var c = t[h], d = 0; d < r.length; d++) {
                ...
                if (!OrgChart.isNEU(c[g])) {
                    ...
                    if (
                        null !=
                        (e = OrgChart._search.searchAndComputeScore(l, p, g, n))
                    ) {
                        var u = c.id;
                        if (s[u]) {
                            if (s[u] && s[u] < e.__score) {
                                ...
                                for (var f = o.length - 1; f >= 0; f--)
                                    o[f].id == u && o.splice(f, 1);
                                OrgChart._search.addNodeToResult(
                                    o,
                                    i,
                                    c,
                                    e,
    ...
    (OrgChart._search.addNodeToResult = function (t, e, r, i, a, n) {
        ...
        null != i &&
            ...
            OrgChart.isNEU(o.__searchMarks) &&
    ...
    (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
        ...
        for (c = n.length - 1; c >= 0; c--)
            f = (f = f.insert(n[c].start + n[c].length, "</mark>")).insert(
                n[c].start,
                "<mark>"
            );
            ...
            for (var i = 0; i < e.length; i++) {
                ...
                if (!OrgChart.isNEU(a))
                    for (var n = 0; (n = t.indexOf(a, n)) > -1; )
                        r.push({ length: a.length, start: n }), (n += a.length);
            }
        return (
            r.sort(function (t, e) {
        ...
        if (o) {
            ...
            if (o.writeToUrlParams) {
                ...
                h.has(l.paramScale)
                    ...
                    h.has(l.paramX)
                        ? h.set(l.paramX, s.x)
                        : h.append(l.paramX, s.x),
                    h.has(l.paramY)
                        ? h.set(l.paramY, s.y)
                        : h.append(l.paramY, s.y),
                    h.has(l.paramExp)
    ...
    (OrgChart.elements.textbox = function (t, e, r, i) {
        ...
        return (
            e.btn &&
                (n = `<a href="#" boc-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
            {
    ...
    (OrgChart.input.validate = function (t) {
        ...
        return a && "" == e.value
            ? ((r.innerHTML +=
                  '<span class="boc-validation-error-message">&nbsp;' +
                  a +
                  "</span>"),
    ...
    (OrgChart.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            var t = Array.isArray(this.instance.config.filterBy),
                e = this,
            ...
            r && r.parentNode.removeChild(r),
                ...
                (r.style.position = "absolute"),
                r.setAttribute("class", "boc-filter"),
                (r.style.top = this.instance.config.padding + "px"),
                (r.style.left = this.instance.config.padding + "px");
            for (var i = "", a = 0; a < this.instance.editUI.fields.length; a++)
                ((!t &&
                    ...
                    (t &&
                        this.instance.config.filterBy.has(
                            this.instance.editUI.fields[a]
                        ))) &&
                    (i += `<div data-filter-field="${this.instance.editUI.fields[a]}">${this.instance.editUI.fields[a]}</div>`);
            (r.innerHTML = `<div>${i}</div>`),
                r.addEventListener("click", function (t) {
                    if (
                        ...
                        for (
                            var r = t.target.getAttribute("data-filter-field"),
                                i =
                                    e.instance.element.querySelectorAll(
                                        "[data-filter-menu]"
                                    ),
                                a = 0;
                            a < i.length;
                        ...
                        var n = e.instance.element.querySelectorAll(
                            ".filter-field-selected"
                        );
                        for (a = 0; a < n.length; a++)
                            n[a].classList.remove("filter-field-selected");
                        var o = e.instance.element.querySelector(
                            "[data-filter-close]"
                        );
                        if (
                        ...
                        var l = e.instance.element.querySelector(
                            `[data-filter-menu="${r}"]`
                        );
                        if (!l) {
                            ...
                            for (
                                a = 0;
                                a < e.instance.config.nodes.length;
                                a++
                            ) {
                            ...
                            ((l =
                                ...
                                l.setAttribute("data-filter-menu", r),
                                l.classList.add("boc-filter-menu"),
                                t.target.parentNode.parentNode.appendChild(l);
                            var d = l.querySelectorAll("input");
                            for (a = 0; a < d.length; a++)
                                d[a].addEventListener("change", function (t) {
                        ...
                        (l.style.display = "block"),
                            ...
                            (o.innerHTML = "x"),
                            o.setAttribute("data-filter-close", ""),
                            t.target.parentNode.appendChild(o);
                    }
                }),
    ...
    (OrgChart.remote._setPositions = function (t, e, r, i) {
        for (
            var a = [],
                n = [],
                o = OrgChart.remote._toReqLayoutConfigsDTO(e),
                l = 0;
            l < t.length;
            l++
        )
